...
def build_tools():
    ...
    return ScrapeWebsiteTool(), SerperDevTool()
# -------------------------
# 1) HTTP HELPERS
# -------------------------
...
# 3) AGENTS
# -------------------------
def build_crew(scrape_tool, search_tool):
...
def main():
    ...
    scrape_tool, search_tool = build_tools()
    investment_crew = build_crew(scrape_tool, search_tool)

    parser = argparse.ArgumentParser(description="CrewAI Investment Analyzer (FMP + Serper)")
